...
<div class="auth-wrap">
  ...
  <div class="auth-card">
    ...
    <div class="auth-card-head">
      ...
      <p>Set up your zone and zonal admin account. Add all the churches in your zone below.</p>
    </div>
    ...
    <form method="POST" action="">
      ...
      <div class="form-section">
        ...
        <div class="field-group">
          ...
          <input type="text" id="zone_name" name="zone_name" class="field-input"
                 placeholder="e.g. Isara Zone" required
        ...
        <div id="churches-container">
          <div class="church-row">
            <input type="text" name="churches[]" class="field-input"
                   placeholder="e.g. Zonal HQ" required
          ...
          <?php if (!empty($_POST['churches'])): ?>
            ...
            <div class="church-row">
              <input type="text" name="churches[]" class="field-input"
                     placeholder="e.g. Church Name" required
      ...
      <!-- Admin Account -->
      <div class="form-section">
        <span class="form-section-label">Zonal admin account</span>
