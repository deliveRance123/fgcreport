...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 560px) {
    ...
    .hero-inner { padding: 52px 16px 60px; }
...
<section class="hero">
  ...
  ?>
    <video autoplay muted loop playsinline preload="auto" class="hero-bg-video">
  ...
  <div class="hero-inner">
    ...
    <?php if ($activeShowcaseSource): ?>
      <div class="hero-showcase-panel">
        <video autoplay muted loop playsinline preload="auto" class="hero-showcase-video">
